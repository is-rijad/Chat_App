export class Konstante {
  ...
  public static readonly imeGrupe = "imeGrupe";
  public static readonly zavrsiPrivatniChat = "ZavrsiPrivatniChat";
  public static readonly zavrsioPrivatniChat = "ZavrsioPrivatniChat";
